...
export const environment: Environment = {
  ...
  pyodidePackages: ["numpy\u003e=1.24.0","pandas\u003e=2.0.0","statsmodels\u003e=0.14.0","scikit-learn\u003e=1.3.0","plotly\u003e=5.18.0","dcor\u003e=0.6","click\u003e=8.0.0"],
  webrVersion: '0.5.0',
  webrPackages: [],
  pluginDefinition: {
    "plugin": {
      "id": "distance-correlation",
      "name": "Distance Correlation Analysis",
      "description": "Calculate distance correlation between protein abundance and multiple target variables with FDR BH correction.",
      "version": "1.0.0",
    ...
    "runtime": {
      ...
      "entrypoint": "distance_correlation.py"
    },
    "inputs": [
      {
        "name": "input_file",
      ...
      },
      {
        ...
        "type": "text",
        "required": true,
        "description": "Comma-separated list of numeric column names from annotation to correlate with."
      },
      {
        "name": "grouping_col",
      ...
      {
        "name": "num_resamples",
        "label": "Permutation Resamples",
        "type": "number",
        "required": false,
        "default": 199,
        "description": "Number of resamples for permutation test p-value calculation.",
        "min": 99,
        "max": 999,
        "step": 100
      },
    ...
    "outputs": [
      ...
      },
      {
        ...
        "type": "html",
        "description": "Volcano plot showing distance correlation vs significance.",
        "format": "html"
      },
      {
        "name": "scatter_plots",
      ...
      },
      {
        ...
        "type": "html",
        "description": "Bar plot showing proteins ranked by distance correlation.",
        "format": "html"
      }
    ],
    "annotation": {
  ...
  pluginScript: `"""Distance correlation analysis with FDR BH correction."""
...
`,
  ...
  exampleFiles: [{"inputName":"annotation_file","inputLabel":"Sample Annotation File","filename":"annotation_with_score.txt","path":"diann/annotation_with_score.txt"},{"inputName":"input_file","inputLabel":"Input File","filename":"imputed.data.txt","path":"diann/imputed.data.txt"}]
};
